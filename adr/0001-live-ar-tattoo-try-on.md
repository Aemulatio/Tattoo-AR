...
| Phase 3 — forearm surface        | In progress | On `phase-3-forearm-surface`: side selection, stable local frame, roll evidence/confidence, reusable 12×24 tapered mesh, UVs, anatomical radius fallback, wireframe, and seam visualization implemented; mask radius estimation and device feasibility gate remain |
